...
Public Class BarcodesInformation
	...
	Const AllowableCharacters As String = NewLine + NewLine + "Allowable characters: "
	Const ASCIISymbols As String = "standard ASCII symbols(0..127)"
	Const ExtendedASCIISymbols As String = ", extended ASCII symbols(128..255)"
	Const Digits As String = "digits 0-9"
	Const LettersAZ As String = "letters A-Z(upper case only)"
	Const CheckSumOptional As String = NewLine + NewLine + "It has optional Checksum!"
	Const NoCheckSum As String = NewLine + NewLine + "There is no checksum!"
	Const MinMaxForPostal As String = NewLine + NewLine + "Barcode must contain min 5 and max 40 digits."

	Shared _info As New Hashtable()
	...
	Shared Sub New()
		...
		text.Append(AllowableCharacters)
		text.Append(Digits)
		text.Append("." & vbLf & vbLf & "Value must contain at least 10 digits." & vbLf & "First two digits can be 11, 87, 45, 92, 59, 62, 44.")
		...
		text.Append(AllowableCharacters)
		text.Append(Digits)
		text.Append("." & vbLf & vbLf & "Value must contain 20, 25, 29 or 31 digits. Second digit must be 0-4.")
		...
		' PDF417Compact
		text.Length = 0
		text.Append("PDF417 Compact is a two-dimension barcode symbology based on PDF417 barcode symbology. It does not contain stop symbol and right row indicator. " & vbLf & vbLf & "For more info see PDF417.")
	...
	Public Shared Function GetInformation(barcodeType As BarcodeType) As String
		If _info.ContainsKey(barcodeType) Then
			Return DirectCast(_info(barcodeType), String)
		End If
		Return ""
	End Function

	Public Shared Function GetInformation(barcodeSubset As BarcodeSymbologySubset) As String
		If _info.ContainsKey(barcodeSubset) Then
			Return DirectCast(_info(barcodeSubset), String)
		End If
		Return ""
	End Function
